...
\begin{theorem}[Schmidt decomposition]
    Let $V$ and $W$ be inner product spaces of dimension $n$ and $m$ respectively. For any $u \in V \tensor W$ there exist orthonormal vectors $x_1, \ldots, x_{m \meet n} \in V$ and $y_1, \ldots, y_{m \meet n} \in W$ such that $u = \sum_i \alpha_i x_i \tensor y_i$, and such that $\alpha_i \geq 0$. % TODO uniqueness of the coefficients.
\end{theorem}
